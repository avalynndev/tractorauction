/**
 * Complete list of districts for all Indian states and union territories
...
export const indianDistricts: Record<string, string[]> = {
  "Andhra Pradesh": [
    ...
    "Eluru", "Kakinada", "Konaseema", "NTR", "Palnadu", "Parvathipuram Manyam",
    "Sri Balaji", "Sri Sathya Sai", "Tirupati"
  ],
  "Arunachal Pradesh": [
  ...
  "Punjab": [
    ...
    "Sangrur", "S.A.S. Nagar", "Shahid Bhagat Singh Nagar", "Sri Muktsar Sahib",
    "Tarn Taran"
  ],
  "Rajasthan": [
...
export function getAllStates(): string[] {
  return Object.keys(indianDistricts);
}
